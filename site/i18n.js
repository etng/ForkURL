(() => {
	...
	const messages = {
		zh: {
			...
			"home.features.icons.description": "内置 Simple Icons 与 Lucide 图标，也可选择启用 Iconify 在线搜索并缓存到本地。",
			...
			"privacy.iconify.summary": "Iconify 搜索默认关闭。开启后，图标选择器会向 Iconify 服务请求搜索结果；选中的图标会缓存在本地。ForkURL 遥测不会记录图标搜索词。",
		...
		en: {
			...
			"home.features.icons.description": "Use bundled Simple Icons and Lucide icons, or optionally enable Iconify search and cache selected icons locally.",
			...
			"privacy.iconify.summary": "Iconify search is off by default. When enabled, the icon picker requests search results from Iconify; selected icons are cached locally. ForkURL telemetry does not record icon search terms.",
